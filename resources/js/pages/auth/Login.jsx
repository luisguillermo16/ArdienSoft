...
import { Mail, Lock, Eye, ArrowRight, User, Shield } from 'lucide-react';
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-[#FE5516] mb-2">
              Ardien<span className="bg-gradient-to-r from-[#FE5516] to-[#ff7a4d] bg-clip-text text-transparent">Soft</span>
            </h1>
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-[#FE5516] border-gray-300 rounded focus:ring-[#FE5516]"
                  />
                  <span className="ml-2 text-sm text-gray-600">
                    Recordarme
                  </span>
                </label>
                <a href="#" className="text-sm text-[#FE5516] hover:text-[#ff7a4d]">
                  ¿Olvidaste tu contraseña?
                </a>
              </div>

              {/* Login Button */}
              <button className="w-full py-3 bg-gradient-to-r from-[#FE5516] to-[#ff7a4d] text-white font-bold rounded-xl shadow-lg hover:shadow-xl relative overflow-hidden">
